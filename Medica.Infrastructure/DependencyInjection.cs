...
using Medica.Infrastructure.Authentication;
using Medica.Infrastructure.Authorization;
using Medica.Infrastructure.Database;
using Medica.SharedKernel.Interfaces;
using Medica.SharedKernel.Specifications;
...
namespace Medica.Infrastructure;
